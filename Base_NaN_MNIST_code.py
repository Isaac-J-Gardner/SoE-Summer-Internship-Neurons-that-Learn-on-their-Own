...
optimiser_recon = torch.optim.SGD(model.parameters(), lr=1)
optimiser_task = torch.optim.SGD(model.parameters(), lr=0.1)
...
for epoch in range(epochs):
    ...
    train_both(train_loader, model, criterion, recon_criterion, optimiser_task)
