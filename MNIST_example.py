...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 32, 3, 1) #a convolution layer, 1 input channel, 32 output channels, aka, 32 different learned convolutions
                                            ...
                                            # each pixel in the output images being the output of a neuron whos inputs are 9 of the inputs and whos weights are the values from the kernel.
        ...
        self.dropout1 = nn.Dropout(0.25)#during training, randomly zeroes some of the elements of the input tensor
