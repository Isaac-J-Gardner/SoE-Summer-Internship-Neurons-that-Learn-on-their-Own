...
for e in range(epochs+1):
    if (e)%5 == 0:
        ...
        for title, mat in [("encoder", W), ("decoder", W2)]:
            ...
            plt.tight_layout()
            plt.savefig(f"Spiking_Neural_Networks/Images/local/no_bias/{title}_e{e}.png")
            plt.close()
        ...
        plt.tight_layout()
        plt.savefig(f"Spiking_Neural_Networks/Images/local/no_bias/inhib_e{e}.png")
        plt.close(fig)
...
plt.savefig("Spiking_Neural_Networks/Images/local/no_bias/accuracy.png")
plt.close()
...
plt.xlabel('Epoch')
plt.ylabel('R_eff')
plt.savefig("Spiking_Neural_Networks/Images/local/no_bias/effective_rank.png")
plt.close()
...
plt.savefig("Spiking_Neural_Networks/Images/local/no_bias/firing_rate.png")
plt.close()
...
plt.savefig("Spiking_Neural_Networks/Images/local/no_bias/threshold.png")
plt.close()
...
plt.xlabel('Epoch')
plt.ylabel('W_ing > 0')
plt.savefig("Spiking_Neural_Networks/Images/local/no_bias/W_inh.png")
plt.close()
