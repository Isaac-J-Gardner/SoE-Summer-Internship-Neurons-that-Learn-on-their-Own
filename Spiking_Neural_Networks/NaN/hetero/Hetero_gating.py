...
LEARN_BETA = False    # train the betas (heterogeneous training) vs hold them fixed
...
def train(network, trainloader, opti, epoch):
    ...
    for batch_idx, (real_img, labels) in enumerate(trainloader):
        ...
        x, x_recon, activity = network(real_img)

        loss_val = recon_loss(x_recon, x, activity)
